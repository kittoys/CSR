...
// Distribusi musiman 2026 Jan-Jul mengikuti pola historis dengan slight downtrend
// Berdasarkan data 2023-2025 pattern
const monthlyData = {
  "2026-01": { budget: 20000000, proposals: 45 }, // Jan: tinggi (mirroring 2025 peak)
  "2026-02": { budget: 12000000, proposals: 25 }, // Feb: rendah
  "2026-03": { budget: 15000000, proposals: 30 }, // Mar: medium-down
  "2026-04": { budget: 17000000, proposals: 35 }, // Apr: medium
  "2026-05": { budget: 18000000, proposals: 37 }, // May: medium
  "2026-06": { budget: 19000000, proposals: 40 }, // Jun: medium-up
  "2026-07": { budget: 13000000, proposals: 28 }, // Jul: rendah (turun dari peak)
};
...
async function insertDummyProposals2026Final() {
  try {
    console.log(
      "📝 Mulai membuat dummy proposal 2026 (Jan-Jul) dengan jumlah lebih realistis...\n",
    );
