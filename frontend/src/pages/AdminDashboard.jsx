...
const AdminDashboard = () => {
  ...
  const fetchPrograms = async () => {
    try {
      ...
      setError("Gagal memuat program. Pastikan sudah login.");
    } finally {
      setLoading(false);
    }
  };
    ...
    try {
      ...
      const msg =
        ...
        (err.response?.status === 401
          ? "Sesi berakhir atau belum login."
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      const msg =
        err.response?.data?.message || "Gagal menghapus program (butuh login)";
      toast.error(msg);
    }
  };
      ...
      <div className="admin__header">
        <div className="admin__header-content">
          <div>
            ...
            <p className="muted">
              Tambah, ubah, dan hapus data program.
              <br />
